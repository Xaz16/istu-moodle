...
function print_view() {
    ...
    print "<script type='text/javascript'>
                function toggle_compression() {
                    window.location.href = 'multistandings.php?courseids=$courseids_list&ids=$ids_list&compress=$not_use_compression';
                }
            </script>";
...
function print_settings() {
    ...
    if ($count_ids > 0) {
        print "<a href='/multistandings.php"
            . "?ids="
            . "&courseids="
            . "&tab=settings"
    ...
    print "<form action='/multistandings.php' method='get' style='text-align: center; margin-bottom: 15px;'>
        <b>Поиск курса: </b>
    ...
    foreach ($matched_courses as $cur_course) {
        ...
        foreach ($cur_course_contests as $cur_contest) {
            ...
            if (isset($courseids_set[$cur_course->id])) {
                ...
                $course_action_html = "<a href='/multistandings.php"
                    . "?ids=$ids_list"
            ...
            if (isset($ids_set[$cur_cm->id])) {
                ...
                $contest_action_html = "<a href='/multistandings.php"
...
$PAGE->set_url('/multistandings.php', array());
